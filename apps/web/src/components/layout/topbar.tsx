...
import { Moon, Sun, Menu, Settings, User, Bot } from "lucide-react";
...
export function Topbar() {
  ...
  const { setSidebarMobileOpen, toggleAssistant } = useUIStore();
  ...
  return (
    <>
      ...
      {/* Assistant drawer — renders outside header flow */}
      <AssistantDrawer />
    </>
  );
}
